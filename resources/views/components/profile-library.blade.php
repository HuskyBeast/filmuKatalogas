<div class="bg-gray-100">
    <div class="py-10 mx-auto">
        ...
        <div class="flex flex-wrap justify-center gap-5 mx-auto w-full">
            
        <!-- Movie card example -->
        @if ($films != "no films")
        @foreach ($films as $film)
            <div class="rounded-md bg-blue-800">
                <a href='{{ url("/film/$film->id") }}'><img src='{{ asset("storage/films/covers/$film->cover") }}' class="rounded-t-md w-52 h-72"></a>
